...
#include "header/model/energy_storage_model/es_converter_model.h"
#include "header/model/energy_storage_model/es_electrical_model.h"
#include "header/model/energy_storage_model/es_battery_model.h"
#include "header/model/energy_storage_model/es_vrt_model.h"
#include "header/model/energy_storage_model/es_relay_model.h"
