...
class VSC : public CONVERTER
{
    public:
        ...
        void set_number_of_bridge(const size_t n);
        ...
        size_t get_number_of_bridge() const;
        ...
        virtual VSC& operator=(const VSC& hvdc);
    ...
    private:
    private: // the following functions will not be implemented
