...
{
    public:
        LCC_HVDC2T(iSTEPS& toolkit);
        virtual ~LCC_HVDC2T();

        void set_converter_bus(CONVERTER_SIDE converter, const size_t bus);
        ...
        void set_converter_number_of_bridge(CONVERTER_SIDE converter, const size_t nbridge);
        ...
        void set_converter_transformer_number_of_taps(CONVERTER_SIDE converter, const size_t ntap);

        size_t get_converter_bus(CONVERTER_SIDE converter) const;
        ...
        size_t get_converter_number_of_bridge(CONVERTER_SIDE converter) const;
        ...
        size_t get_converter_transformer_number_of_taps(CONVERTER_SIDE converter) const;
    ...
    private:
        ...
        size_t converter_valve_bus_name_index[2];
        size_t identifier_index;
        size_t hvdc_name_index;
        bool status;
