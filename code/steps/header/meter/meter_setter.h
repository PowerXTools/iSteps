...
class METER_SETTER
{
    public:
        ...
        METER prepare_ac_line_current_in_kA_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_active_power_in_MW_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_reactive_power_in_MVar_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_apparent_impedance_in_Ohm_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_apparent_impedance_angle_in_deg_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_current_in_pu_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_active_power_in_pu_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_reactive_power_in_pu_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_apparent_impedance_in_pu_meter(const DEVICE_ID& device_id, size_t side_bus);
        METER prepare_ac_line_apparent_impedance_angle_in_rad_meter(const DEVICE_ID& device_id, size_t side_bus);
        ...
        METER prepare_vsc_hvdc_converter_dc_current_in_kA_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_converter_ac_current_in_kA_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_converter_ac_voltage_in_kV_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_converter_ac_voltage_in_pu_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_converter_dc_power_in_MW_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_converter_dc_voltage_in_kV_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_converter_ac_active_power_in_MW_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_converter_ac_reactive_power_in_MVar_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_dc_bus_voltage_in_kV_meter(const DEVICE_ID& device_id, size_t meter_side);
        METER prepare_vsc_hvdc_dc_line_current_in_kA_meter(const DEVICE_ID& device_id, const DC_DEVICE_ID dc_did, size_t meter_side);
        METER prepare_vsc_hvdc_dc_line_power_in_MW_meter(const DEVICE_ID& device_id, const DC_DEVICE_ID dc_did, size_t meter_side);
        METER prepare_vsc_hvdc_model_internal_variable_meter(const DEVICE_ID& device_id, string var_name, size_t meter_side);
    ...
    private:
        ...
        bool prepare_ac_line_meter(METER& meter, const DEVICE_ID& device_id, size_t side_bus);
