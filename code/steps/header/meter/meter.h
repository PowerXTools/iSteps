...
class METER
{
    ...
    private:
        ...
        bool is_internal_variable_name_valid(string& name, size_t index=0) const;
        ...
        DC_DEVICE_ID dc_did;
        size_t meter_type_string_index;
        size_t meter_side_bus;
        size_t internal_variable_name_index;
};
