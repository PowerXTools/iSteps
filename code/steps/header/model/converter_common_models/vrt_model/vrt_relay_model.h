...
{
    public:
        VRT_RELAY_MODEL(iSTEPS& toolkit);
        ~VRT_RELAY_MODEL();
        ...
        size_t get_vrt_point_number() const;
        double get_vrt_time_threshold(size_t index) const;
        double get_vrt_volt_threshold(size_t index) const;
        ...
        void set_point_time_with_index(size_t index, double value);
        void set_point_voltage_with_index(size_t index, double value);
