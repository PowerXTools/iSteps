#ifndef WT_GENERATOR_MODEL_H
#define WT_GENERATOR_MODEL_H
...
class WT_GENERATOR_MODEL : public WTG_MODEL
{
    /*
    ...
    */
    ...
    public:
        WT_GENERATOR_MODEL(iSTEPS& toolkit);
