...
class WTVRTRLY1 : public WT_RELAY_MODEL
{
    ...
    public: // specific model level
        ...
        size_t get_lvrt_point_number() const;
        double get_lvrt_time_threshold(size_t index) const;
        double get_lvrt_volt_threshold(size_t index) const;
        double get_lvrt_trip_scale() const;
        size_t get_hvrt_point_number() const;
        double get_hvrt_time_threshold(size_t index) const;
        double get_hvrt_volt_threshold(size_t index) const;
