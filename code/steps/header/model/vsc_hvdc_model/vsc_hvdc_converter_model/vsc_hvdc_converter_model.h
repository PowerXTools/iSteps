...
{
    public:
        VSC_HVDC_CONVERTER_MODEL(iSTEPS& toolkit);
    ...
    public: // model type
        ...
        size_t get_converter_name_index() const;
        size_t get_converter_index() const;
        size_t get_converter_bus() const;
        ...
        complex<double> get_converter_dynamic_S_from_converter_to_AC_bus_in_MVA() const;
        ...
        double get_converter_initial_ac_angle_at_ac_bus_side_in_rad() const;
        double get_converter_initial_ac_angle_at_ac_bus_side_in_deg() const;
    ...
    private:
        ...
        size_t control_mode; // change to enum, dynamic version.
