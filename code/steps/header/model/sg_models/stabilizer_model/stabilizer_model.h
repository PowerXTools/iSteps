...
class STABILIZER_MODEL : public SG_MODEL
{
    ...
    */
    public:
        STABILIZER_MODEL(iSTEPS& toolkit);
    ...
    private:
        const SIGNAL* get_const_pointer_of_signal_at_slot(size_t slot) const;
        SIGNAL* get_nonconst_pointer_of_signal_at_slot(size_t slot);
    private:
