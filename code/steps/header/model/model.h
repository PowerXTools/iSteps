...
class MODEL
{
    public:// common model level
        ...
        void add_model_internal_variable_name_and_index_pair(string var_name, size_t var_index);
        size_t get_model_internal_variable_count() const;
        size_t get_model_internal_variable_index(string var_name) const;
        string get_model_internal_variable_name(size_t var_index) const;
        bool is_model_internal_variable_exist(string var_name) const;
        bool is_model_internal_variable_exist(size_t var_index) const;
