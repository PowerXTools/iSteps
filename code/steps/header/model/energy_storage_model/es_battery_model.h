#ifndef ES_BATTERY_MODEL_H
#define ES_BATTERY_MODEL_H

#include "header/model/energy_storage_model/es_model.h"
#include <cstdlib>

class ES_BATTERY_MODEL : public ES_MODEL
{
    public:
        ES_BATTERY_MODEL(iSTEPS& toolkit);
        virtual ~ES_BATTERY_MODEL();
    public:
