...
class PF_SOLVER
{
    public:
        ...
        void set_active_power_mismatch_threshold(double P);
        void set_reactive_power_mismatch_threshold(double Q);
        void set_allowed_max_power_mismatch(const double P, const double Q);
        ...
        void save_powerflow_result(const string& filename) const;
        void save_extended_powerflow_result(const string& filename) const;
        void save_network_Y_matrix(const string& filename) const;
        void save_jacobian_matrix(const string& filename);
    ...
    private:
        ...
        void set_all_regulating_vsc_hvdcs_at_physical_bus_to_q_min(size_t physical_bus);
        void set_all_regulating_vsc_hvdcs_at_physical_bus_to_q_max(size_t physical_bus);

        void allocate_bus_power_mismatch_without_checking_bus_type_constraints();
        void allocate_SLACK_bus_power_mismatch_without_checking_bus_type_constraint(size_t physical_bus);
        void allocate_PV_bus_power_mismatch_without_checking_bus_type_constraint(size_t physical_bus);
