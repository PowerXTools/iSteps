...
class SC_SOLVER
{
    public:
        ...
        void set_max_iteration_cout_for_iterative_method(size_t n);
        size_t get_max_iteration_count_for_iterative_method();
        ...
        void set_bus_fault(size_t bus, FAULT_TYPE type, const complex<double>& fault_shunt);
        void set_ac_line_fault(const DEVICE_ID& line_id, size_t side_bus, double location, FAULT_TYPE fault_type, const complex<double>& fault_shunt);
        void clear_fault();
        bool is_bus_fault();
    ...
    private:
        ...
        complex<double> get_initial_voltage_of_bus_before_short_circuit(size_t bus);
        ...
        size_t get_internal_bus_number_of_physical_bus(size_t bus);
        size_t get_physical_bus_number_of_internal_bus(size_t bus);

        complex<double> get_positive_sequence_equivalent_mutual_impedance_in_pu_between_bus_to_fault_place(size_t bus);
        complex<double> get_negative_sequence_equivalent_mutual_impedance_in_pu_between_bus_to_fault_place(size_t bus);
        complex<double> get_zero_sequence_equivalent_mutual_impedance_in_pu_between_bus_to_fault_place(size_t bus);
        ...
        string get_formatted_sequence_data(size_t bus,string ID,complex<double> F1, complex<double>F2, complex<double> F0, bool to_file=false);
