...
class MULTI_POINT_LINE
{
    ...
    public:
        ...
        double get_point_x_with_index(size_t i) const;
        double get_point_y_with_index(size_t i) const;
        void set_point_y_with_index(size_t i, double value);
        void set_point_x_with_index(size_t i, double value);
        size_t get_valid_point_size() const;
    ...
    private:
        ...
        size_t get_the_last_point_with_x_less_than_or_equal_to(double x);
