...
WT_GENERATOR::WT_GENERATOR(iSTEPS& toolkit) : SOURCE(toolkit)
{
    clear();
}
...
MODEL* WT_GENERATOR::get_model_of_type(string model_type, size_t index)
{
