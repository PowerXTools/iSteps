...
MUTUAL_DATA::MUTUAL_DATA(iSTEPS& toolkit): DEVICE(toolkit)
{
    clear();
}
...
bool MUTUAL_DATA::is_in_area(size_t area) const
{
    ;
}

bool MUTUAL_DATA::is_in_zone(size_t zone) const
{
    ;
}
...
bool MUTUAL_DATA::is_related_to_ac_line(size_t ibus, size_t jbus, const string& identifier)
{
