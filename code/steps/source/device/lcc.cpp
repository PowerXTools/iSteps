...
LCC::LCC(iSTEPS& toolkit) : CONVERTER(toolkit)
{
    this->clear();
}
...
void LCC::set_number_of_bridge(const size_t n) { bridge_number = n; }
...
size_t LCC::get_number_of_bridge() const { return bridge_number; }
