...
EQUIVALENT_DEVICE::EQUIVALENT_DEVICE(iSTEPS& toolkit) : NONBUS_DEVICE(toolkit)
{
    clear();
}
...
size_t EQUIVALENT_DEVICE::get_identifier_index() const
{
...
void EQUIVALENT_DEVICE::check()const
{
    ;
}
...
MODEL* EQUIVALENT_DEVICE::get_model_of_type(string model_type, size_t index)
{
