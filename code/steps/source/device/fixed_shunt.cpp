...
FIXED_SHUNT::FIXED_SHUNT(iSTEPS& toolkit) : NONBUS_DEVICE(toolkit)
{
    clear();
}
...
size_t FIXED_SHUNT::get_identifier_index() const
{
    return identifier_index;
}

size_t FIXED_SHUNT::get_name_index() const
{
    return name_index;
}
...
MODEL* FIXED_SHUNT::get_model_of_type(string model_type, size_t index)
{
