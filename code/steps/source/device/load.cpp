...
LOAD::LOAD(iSTEPS& toolkit) : NONBUS_DEVICE(toolkit)
{
    clear();
    Aptr = NULL;
    Bptr = NULL;
...
size_t LOAD::get_identifier_index() const
{
...
MODEL* LOAD::get_model_of_type(string model_type, size_t index)
{
