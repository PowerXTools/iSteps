...
size_t DEVICE_INDEX_MAP::get_index_of_device(const string vsc_name) const
{
...
size_t DEVICE_INDEX_MAP::get_index_of_device_map(const string vsc_name) const
{
    return 0;
}
...
size_t DEVICE_INDEX_MAP::get_map_size() const
{
