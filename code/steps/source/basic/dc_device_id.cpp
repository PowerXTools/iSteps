...
void DC_DEVICE_ID::set_minimum_allowed_terminal_count(size_t n)
{
    minimum_terminal_count = n;
}

void DC_DEVICE_ID::set_maximum_allowed_terminal_count(size_t n)
{
...
void DC_DEVICE_ID::set_device_identifier_index(size_t index){
    if(allow_identifier)
    {
...
void DC_DEVICE_ID::set_device_name_index(size_t index)
{
    if(allow_name)
    {
...
size_t DC_DEVICE_ID::get_device_identifier_index() const
{
    return device_identifier_index;
}

size_t DC_DEVICE_ID::get_device_name_index() const
{
    return device_name_index;
}

size_t DC_DEVICE_ID::get_minimum_allowed_terminal_count() const
{
    return minimum_terminal_count;
}

size_t DC_DEVICE_ID::get_maximum_allowed_terminal_count() const
{
