...
ES_ELECTRICAL_MODEL::ES_ELECTRICAL_MODEL(iSTEPS& toolkit) : ES_MODEL(toolkit)
{
}
...
void ES_ELECTRICAL_MODEL::set_bus_to_regulate(size_t bus)
{
    bus_to_regulate = bus;
}

size_t ES_ELECTRICAL_MODEL::get_bus_to_regulate()  const
{
