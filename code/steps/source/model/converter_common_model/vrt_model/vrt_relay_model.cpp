...
VRT_RELAY_MODEL::VRT_RELAY_MODEL(iSTEPS& toolkit)
{
    set_toolkit(toolkit);
...
void VRT_RELAY_MODEL::set_toolkit(iSTEPS& toolkit)
{
    this->toolkit = (&toolkit);
}

iSTEPS& VRT_RELAY_MODEL::get_toolkit() const
{
    return *toolkit;
}
...
size_t VRT_RELAY_MODEL::get_bus() const
{
...
size_t VRT_RELAY_MODEL::get_vrt_point_number() const
{
    return vrt_line.get_valid_point_size();
}

double VRT_RELAY_MODEL::get_vrt_time_threshold(size_t index) const
{
    return vrt_line.get_point_x_with_index(index);
}

double VRT_RELAY_MODEL::get_vrt_volt_threshold(size_t index) const
{
...
void VRT_RELAY_MODEL::set_point_time_with_index(size_t index, double value)
{
    vrt_line.set_point_x_with_index(index, value);
}

void VRT_RELAY_MODEL::set_point_voltage_with_index(size_t index, double value)
{
