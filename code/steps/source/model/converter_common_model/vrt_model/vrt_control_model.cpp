...
VRT_CONTROL_MODEL::VRT_CONTROL_MODEL(iSTEPS& toolkit)
{
    set_toolkit(toolkit);
    bus_ptr = NULL;
...
void VRT_CONTROL_MODEL::set_toolkit(iSTEPS& toolkit)
{
    this->toolkit = (&toolkit);
    prepare2recover_timer.set_toolkit(toolkit);
}

iSTEPS& VRT_CONTROL_MODEL::get_toolkit() const
{
    return *toolkit;
}
...
size_t VRT_CONTROL_MODEL::get_bus() const
{
