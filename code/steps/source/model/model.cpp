...
iSTEPS& MODEL::get_toolkit() const
{
    return *toolkit;
}

void MODEL::set_toolkit(iSTEPS& toolkit)
{
...
void MODEL::add_model_internal_variable_name_and_index_pair(string var_name, size_t var_index)
{
    if(model_internal_variable_table!=NULL)
        model_internal_variable_table->add_variable_name_index_pair(var_name, var_index);
}

size_t MODEL::get_model_internal_variable_count() const
{
    return model_internal_variable_table->size();
}

size_t MODEL::get_model_internal_variable_index(string var_name) const
{
    if(model_internal_variable_table!=NULL)
...
string MODEL::get_model_internal_variable_name(size_t var_index) const
{
    if(model_internal_variable_table!=NULL)
...
bool MODEL::is_model_internal_variable_exist(size_t var_index) const
{
    if(model_internal_variable_table!=NULL)
        return (*model_internal_variable_table)[var_index]!="";
    else
