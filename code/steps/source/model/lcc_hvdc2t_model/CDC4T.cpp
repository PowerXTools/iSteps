...
using namespace std;
CDC4T::CDC4T(iSTEPS& toolkit) : LCC_HVDC2T_MODEL(toolkit),
...
CDC4T::CDC4T(const CDC4T& model) : LCC_HVDC2T_MODEL(model.get_toolkit()),
...
void CDC4T::solve_2t_lcc_hvdc_model_without_integration()
{
