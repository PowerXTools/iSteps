...
LCC_HVDC2T_MODEL::LCC_HVDC2T_MODEL(iSTEPS& toolkit) : MODEL(toolkit)
{
...
{
    for(size_t i=0; i<STEPS_MAX_HVDC_BYPASS_RECORD_SIZE; ++i)
...
void LCC_HVDC2T_MODEL::set_maximum_count_of_bypassing_before_blocked(size_t n)
{
    if(n==0)
...
{
    size_t n = get_bypass_record_count();
...
size_t LCC_HVDC2T_MODEL::get_bypass_record_count() const
{
    size_t n = 0;
    for(size_t i=0; i<STEPS_MAX_HVDC_BYPASS_RECORD_SIZE; ++i)
    {
