...
WT_VRT_MODEL::WT_VRT_MODEL(iSTEPS& toolkit) : WTG_MODEL(toolkit)
{
    ;
}
...
complex<double> WT_VRT_MODEL::get_terminal_bus_complex_voltage_in_pu() const
{
...
complex<double> WT_VRT_MODEL::get_wt_generator_terminal_generation_in_MVA() const
{
...
complex<double> WT_VRT_MODEL::get_wt_generator_terminal_generation_in_pu_based_on_mbase() const
{
    return get_wt_generator_terminal_generation_in_MVA()/get_mbase_in_MVA();
}

complex<double> WT_VRT_MODEL::get_wt_generator_terminal_complex_current_in_pu() const
{
    WT_GENERATOR* gen = get_wt_generator_pointer();
