...
WTVRT3::WTVRT3(iSTEPS& toolkit) : WT_VRT_MODEL(toolkit),
...
bool WTVRT3::setup_model_with_steps_string_vector(vector<string>& data)
{
    ...
    if(data.size()>=58)
    {
        ...
        if(model_name == get_model_name())
        {
            ...
            size_t P_lvrt_during_mode, Q_lvrt_during_mode;
            size_t P_lvrt_prepare2recover_mode, Q_lvrt_prepare2recover_mode;
            size_t P_lvrt_recover_mode, Q_lvrt_recover_mode;
            ...
            size_t P_hvrt_during_mode, Q_hvrt_during_mode;
            size_t P_hvrt_prepare2recover_mode, Q_hvrt_prepare2recover_mode;
            size_t P_hvrt_recover_mode, Q_hvrt_recover_mode;
