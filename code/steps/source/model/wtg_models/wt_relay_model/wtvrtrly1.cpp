...
WTVRTRLY1::WTVRTRLY1(iSTEPS& toolkit) : WT_RELAY_MODEL(toolkit),
                                   lvrt(toolkit),
                                   hvrt(toolkit)
{
    clear();
...
size_t WTVRTRLY1::get_lvrt_point_number() const
{
    return lvrt.get_vrt_point_number();
}

double WTVRTRLY1::get_lvrt_time_threshold(size_t index) const
{
    return lvrt.get_vrt_time_threshold(index);
}

double WTVRTRLY1::get_lvrt_volt_threshold(size_t index) const
{
...
size_t WTVRTRLY1::get_hvrt_point_number() const
{
    return hvrt.get_vrt_point_number();
}

double WTVRTRLY1::get_hvrt_time_threshold(size_t index) const
{
    return hvrt.get_vrt_time_threshold(index);
}

double WTVRTRLY1::get_hvrt_volt_threshold(size_t index) const
{
...
string WTVRTRLY1::get_standard_psse_string(bool export_internal_bus_number) const
{
    ...
    size_t n=get_lvrt_point_number();
...
void WTVRTRLY1::prepare_model_data_table()
{
    ...
    for(size_t j=0; j<get_lvrt_point_number(); ++j)
    {
    ...
    for(size_t j=0; j<get_hvrt_point_number(); ++j)
    {
