...
#include <iostream>
using namespace std;
URCSCT::URCSCT(iSTEPS& toolkit) : TURBINE_GOVERNOR_MODEL(toolkit),
...
string URCSCT::get_standard_psse_string(bool export_internal_bus_number) const
{
    ostringstream osstream;
...
void URCSCT::build_linearized_matrix_ABCD()
{
    return;
}
