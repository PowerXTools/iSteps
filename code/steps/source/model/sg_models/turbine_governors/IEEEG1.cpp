...
#include <iostream>
using namespace std;
IEEEG1::IEEEG1(iSTEPS& toolkit) : TURBINE_GOVERNOR_MODEL(toolkit),
                                 droop(toolkit),
                                 servo_motor(toolkit),
                                 delayer1(toolkit),
                                 delayer2(toolkit),
...
string IEEEG1::get_standard_psse_string(bool export_internal_bus_number) const
{
    ostringstream osstream;
...
void IEEEG1::build_linearized_matrix_ABCD()
{
    return;
}
