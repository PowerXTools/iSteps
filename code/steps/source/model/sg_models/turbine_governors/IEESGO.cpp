...
IEESGO::IEESGO(iSTEPS& toolkit) : TURBINE_GOVERNOR_MODEL(toolkit),
...
string IEESGO::get_standard_psse_string(bool export_internal_bus_number) const
{
    ostringstream osstream;
...
void IEESGO::build_linearized_matrix_ABCD()
{
    return;
}
