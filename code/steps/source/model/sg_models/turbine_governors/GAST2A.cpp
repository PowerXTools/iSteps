...
#include <iostream>
using namespace std;
GAST2A::GAST2A(iSTEPS& toolkit) : TURBINE_GOVERNOR_MODEL(toolkit),
...
string GAST2A::get_standard_psse_string(bool export_internal_bus_number) const
{
    ostringstream osstream;
...
void GAST2A::build_linearized_matrix_ABCD()
{
    return;
}
