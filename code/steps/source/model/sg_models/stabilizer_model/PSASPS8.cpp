...
#include <vector>
PSASPS8::PSASPS8(iSTEPS& toolkit) : STABILIZER_MODEL(toolkit),
                                   sensor(toolkit),
...
string PSASPS8::get_standard_psse_string(bool export_internal_bus_number) const
{
    ostringstream osstream;
...
void PSASPS8::prepare_model_internal_variable_table()
{
    ...
    add_model_internal_variable_name_and_index_pair("STATE@VOLTAGE SENSOR", i); i++;
    ...
    add_model_internal_variable_name_and_index_pair("OUTPUT@VOLTAGE SENSOR", i); i++;
