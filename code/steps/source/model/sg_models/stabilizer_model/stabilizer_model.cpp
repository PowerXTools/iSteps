...
using namespace std;
STABILIZER_MODEL::STABILIZER_MODEL(iSTEPS& toolkit) : SG_MODEL(toolkit),
                                                     signal_0(toolkit),signal_1(toolkit),
                                                     signal_2(toolkit),signal_3(toolkit),
                                                     signal_4(toolkit)
{
    for(size_t slot=0; slot<STEPS_MAX_STABILIZER_INPUT_SIGNAL_SLOT; ++slot)
    {
...
const SIGNAL* STABILIZER_MODEL::get_const_pointer_of_signal_at_slot(size_t slot) const
{
...
SIGNAL* STABILIZER_MODEL::get_nonconst_pointer_of_signal_at_slot(size_t slot)
{
    SIGNAL* signal = NULL;
    switch(slot)
    {
