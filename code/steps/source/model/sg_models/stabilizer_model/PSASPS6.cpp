...
However, it is modeled as a DIFFERENTIAL_BLOCK in iSTEPS.
Further check is necessary.
***/
PSASPS6::PSASPS6(iSTEPS& toolkit) : STABILIZER_MODEL(toolkit),
...
void PSASPS6::build_linearized_matrix_ABCD()
{
    return;
}
