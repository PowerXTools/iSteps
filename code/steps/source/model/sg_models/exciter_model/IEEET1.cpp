...
using namespace std;
IEEET1::IEEET1(iSTEPS& toolkit) : EXCITER_MODEL(toolkit),
                                 sensor(toolkit),
                                 regulator(toolkit),
                                 feedbacker(toolkit),
                                 exciter(toolkit)
...
double IEEET1::get_minimum_nonzero_time_constant_in_s()
{
...
void IEEET1::build_linearized_matrix_ABCD()
{
    return;
}
