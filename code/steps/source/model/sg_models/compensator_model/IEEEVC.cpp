...
using namespace std;
IEEEVC::IEEEVC(iSTEPS& toolkit) : COMPENSATOR_MODEL(toolkit)
{
    clear();
}
...
string IEEEVC::get_standard_psse_string(bool export_internal_bus_number) const
{
    ostringstream osstream;
...
void IEEEVC::build_linearized_matrix_ABCD()
{
    return;
}
