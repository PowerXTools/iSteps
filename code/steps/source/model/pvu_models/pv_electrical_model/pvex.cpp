#include "header/model/pvu_models/pv_electrical_model/pvex.h"
...
PVEX::PVEX(iSTEPS& toolkit) : PV_ELECTRICAL_MODEL(toolkit),
...
PVEX::PVEX(const PVEX& model) : PV_ELECTRICAL_MODEL(model.get_toolkit()),
...
PVEX& PVEX::operator=(const PVEX& model)
{
...
void PVEX::copy_from_const_model(const PVEX& model)
{
...
string PVEX::get_model_name() const
{
    return "PVEX";
}

void PVEX::set_Xcomp_in_pu(double Xc)
{
    Xcomp = Xc;
}

void PVEX::set_TRV_in_s(double T)
{
    voltage_sensor.set_T_in_s(T);
}

void PVEX::set_Fn(double Fn)
{
    this->Fn = Fn;
}

void PVEX::set_KIV(double K)
{
    if(K!=0.0)
        voltage_regulator_integrator.set_T_in_s(1.0/K);
}

void PVEX::set_Qmax_in_pu(double q)
{
    voltage_regulator_integrator.set_upper_limit(q);
}

void PVEX::set_Qmin_in_pu(double q)
{
    voltage_regulator_integrator.set_lower_limit(q);
}

void PVEX::set_KPV(double K)
{
    voltage_regulator_first_order_block.set_K(K);
}

void PVEX::set_TV_in_s(double T)
{
    voltage_regulator_first_order_block.set_T_in_s(T);
}

void PVEX::set_TFV_in_s(double T)
{
    voltage_regulator_filter.set_T_in_s(T);
}

void PVEX::set_TP_in_s(double T)
{
    active_power_sensor.set_T_in_s(T);
}

void PVEX::set_KQI(double K)
{
    if(K!=0.0)
        Q_error_integrator.set_T_in_s(1.0/K);
}

void PVEX::set_Vmax_in_pu(double v)
{
    Q_error_integrator.set_upper_limit(v);
}

void PVEX::set_Vmin_in_pu(double v)
{
    Q_error_integrator.set_lower_limit(v);
}

void PVEX::set_voltage_flag(size_t flag)
{
    if(flag<3)
        Voltage_Flag = flag;
    else
...
void PVEX::set_KQV(double K)
{
    if(K!=0.0)
        V_error_integrator.set_T_in_s(1.0/K);
}

void PVEX::set_EQmax_in_pu(double I)
{
    EQmax = I;
}

void PVEX::set_EQmin_in_pu(double I)
{
    EQmin = I;
}

void PVEX::set_Kvi(double K)
{
    virtual_inertia_emulator.set_K(K);
}

void PVEX::set_Tvi_in_s(double T)
{
    virtual_inertia_emulator.set_T_in_s(T);
}

void PVEX::set_Kdroop(double K)
{
    frequency_droop_controller.set_K(K);
}

void PVEX::set_Tdroop_in_s(double T)
{
    frequency_droop_controller.set_T_in_s(T);
}

void PVEX::set_frequency_deviation_upper_deadband_in_pu(double f)
{
    f_upper_pu = f;
}

void PVEX::set_frequency_deviation_lower_deadband_in_pu(double f)
{
    f_lower_pu = f;
}

void PVEX::set_Kfint(double K)
{
    double t = 0.0;
...
void PVEX::set_rPmax_in_pu(double r)
{
    max_torque_rate = r;
}

void PVEX::set_rPmin_in_pu(double r)
{
    min_torque_rate = r;
}

void PVEX::set_TFP_in_s(double T)
{
    power_order_integrator.set_T_in_s(T);
}

void PVEX::set_Pmax_in_pu(double p)
{
    power_order_integrator.set_upper_limit(p);
}

void PVEX::set_Pmin_in_pu(double p)
{
    power_order_integrator.set_lower_limit(p);
}

void PVEX::set_IPmax_in_pu(double I)
{
    IPmax = I;
}

double PVEX::get_Xcomp_in_pu() const
{
    return Xcomp;
}

double PVEX::get_TRV_in_s() const
{
    return voltage_sensor.get_T_in_s();
}

double PVEX::get_Fn() const
{
    return Fn;
}

double PVEX::get_KIV() const
{
    return 1.0/voltage_regulator_integrator.get_T_in_s();
}

double PVEX::get_Qmax_in_pu() const
{
    return voltage_regulator_integrator.get_upper_limit();
}

double PVEX::get_Qmin_in_pu() const
{
    return voltage_regulator_integrator.get_lower_limit();
}

double PVEX::get_KPV() const
{
    return voltage_regulator_first_order_block.get_K();
}

double PVEX::get_TV_in_s() const
{
    return voltage_regulator_first_order_block.get_T_in_s();
}

double PVEX::get_TFV_in_s() const
{
    return voltage_regulator_filter.get_T_in_s();
}

double PVEX::get_TP_in_s() const
{
    return active_power_sensor.get_T_in_s();
}

double PVEX::get_KQI() const
{
    return 1.0/Q_error_integrator.get_T_in_s();
}

double PVEX::get_Vmax_in_pu() const
{
    return Q_error_integrator.get_upper_limit();
}

double PVEX::get_Vmin_in_pu() const
{
    return Q_error_integrator.get_lower_limit();
}

size_t PVEX::get_voltage_flag() const
{
    return Voltage_Flag;
}

double PVEX::get_KQV() const
{
    return 1.0/V_error_integrator.get_T_in_s();
}

double PVEX::get_EQmax_in_pu() const
{
    return EQmax;
}

double PVEX::get_EQmin_in_pu() const
{
    return EQmin;
}

double PVEX::get_Kvi() const
{
    return virtual_inertia_emulator.get_K();
}

double PVEX::get_Tvi_in_s() const
{
    return virtual_inertia_emulator.get_T_in_s();
}

double PVEX::get_Kdroop() const
{
    return frequency_droop_controller.get_K();
}

double PVEX::get_Tdroop_in_s() const
{
    return frequency_droop_controller.get_T_in_s();
}

double PVEX::get_frequency_deviation_upper_deadband_in_pu() const
{
    return f_upper_pu;
}

double PVEX::get_frequency_deviation_lower_deadband_in_pu() const
{
    return f_lower_pu;
}

double PVEX::get_Kfint() const
{
...
double PVEX::get_rPmax_in_pu() const
{
    return max_torque_rate;
}

double PVEX::get_rPmin_in_pu() const
{
    return min_torque_rate;
}

double PVEX::get_TFP_in_s() const
{
    return power_order_integrator.get_T_in_s();
}

double PVEX::get_Pmax_in_pu() const
{
    return power_order_integrator.get_upper_limit();
}

double PVEX::get_Pmin_in_pu() const
{
    return power_order_integrator.get_lower_limit();
}

double PVEX::get_IPmax_in_pu() const
{
    return IPmax;
}

bool PVEX::is_frequency_regulation_enabled() const
{
    return frequency_regulation_enabled;
}
void PVEX::trip_frequency_regulation()
{
    if(frequency_regulation_enabled==true)
        frequency_regulation_enabled = false;
}

bool PVEX::setup_model_with_steps_string_vector(vector<string>& data)
{
    ...
    if(data.size()>=35)
    {
        ...
        if(model_name==get_model_name())
        {
            ...
            double tfv, kpv, kiv, xc, tfp, pmax, pmin, qmax, qmin,
                   ipmax, trv, rpmax, rpmin, kqi, vmax, vmin,
...
bool PVEX::setup_model_with_psse_string(string data)
{
    vector<string> record = psse_dyr_string2steps_string_vector(data);
    return setup_model_with_steps_string_vector(record);
}

bool PVEX::setup_model_with_bpa_string(string data)
{
    ostringstream osstream;
...
void PVEX::setup_block_toolkit_and_parameters()
{
}

void PVEX::initialize()
{
    ostringstream osstream;
    if(not is_model_initialized())
    {
        ...
        if(not pvconmodel->is_model_initialized())
            pvconmodel->initialize();
        ...
        if(panelmodel!=NULL)
        {
            ...
            double iterm = get_pv_unit_terminal_current_in_pu();
            //double mbase = get_mbase_in_MVA();
            complex<double> selec = get_pv_unit_terminal_generation_in_pu_based_on_mbase();
            double pelec = selec.real();
            double qelec = selec.imag();
            double pref = get_active_power_reference_in_pu_from_panel_model();

            set_active_power_reference_in_pu(pref);

            double ipcmd = pvconmodel->get_initial_active_current_command_in_pu_based_on_mbase();
            ...
            double iqcmd = pvconmodel->get_initial_reactive_current_command_in_pu_based_on_mbase();
            ...
            if(toolkit.is_detailed_log_enabled())
            {
                osstream<<get_model_name()<<" model of "<<get_compound_device_name()<<" is initialized."<<endl
                        ...
                        <<"(3) initial active power reference: "<<get_active_power_reference_in_pu()<<endl
                        <<"(4) voltage regulator integrator state: "<<voltage_regulator_integrator.get_state()<<endl
                        <<"(5) voltage regulator first order block state: "<<voltage_regulator_first_order_block.get_state()<<endl
                        <<"(6) voltage regulator filter state: "<<voltage_regulator_filter.get_state()<<endl
                        <<"(7) active power sensor state: "<<active_power_sensor.get_state()<<endl
                        <<"(8) reactive power error integrator state: "<<Q_error_integrator.get_state()<<endl
                        <<"(9) voltage error integrator state: "<<V_error_integrator.get_state()<<endl
                        <<"(10) virtual inertia regulator state: "<<virtual_inertia_emulator.get_state()<<endl
                        <<"(11) frequency droop regulator state: "<<frequency_droop_controller.get_state()<<endl
                        <<"(12) reactive voltage command: "<<get_reactive_voltage_command_in_pu()<<endl
                        <<"(13) active current command: "<<get_active_current_command_in_pu_based_on_mbase()<<endl
                        <<"(14) reactive current command: "<<get_reactive_current_command_in_pu_based_on_mbase();
                toolkit.show_information(osstream);
            }
...
void PVEX::run(DYNAMIC_MODE mode)
{
    double vterm = get_terminal_bus_voltage_in_pu();
    double iterm = get_pv_unit_terminal_current_in_pu();
...
/*    if(mode==DYNAMIC_UPDATE_MODE and is_frequency_regulation_enabled())
    ...
    {
        input = pref - power_order_integrator.get_output()
    ...
    //osstream<<"At time "<<toolkit.get_dynamic_simulation_time_in_s()<<", PVEX power_order_integrator input is "<<input;
    //show_information(osstream);
...
double PVEX::get_active_current_command_in_pu_based_on_mbase()
{
    double vterm = get_terminal_bus_voltage_in_pu();
    if(vterm==0.0)
        return 0.0;
...
double PVEX::get_active_power_command_in_pu_based_on_mbase() const
{
    return power_order_integrator.get_output();
}

double PVEX::get_reactive_current_command_in_pu_based_on_mbase()
{
    PV_UNIT* pv_unit = get_pv_unit_pointer();
    double xeq = pv_unit->get_source_impedance_in_pu().imag();
...
double PVEX::get_reactive_power_command_in_pu_based_on_mbase()
{
...
double PVEX::get_reactive_voltage_command_in_pu() const
{
...
string PVEX::get_standard_psse_string(bool export_internal_bus_number) const
{
    ostringstream osstream;
...
void PVEX::prepare_model_data_table()
{
...
double PVEX::get_model_data_with_name(string par_name) const
{
...
void PVEX::set_model_data_with_name(string par_name, double value)
{
    par_name = string2upper(par_name);
...
double PVEX::get_minimum_nonzero_time_constant_in_s()
{
...
void PVEX::prepare_model_internal_variable_table()
{
...
double PVEX::get_model_internal_variable_with_name(string var_name)
{
...
string PVEX::get_dynamic_data_in_psse_format() const
{
    return get_standard_psse_string();
}

string PVEX::get_dynamic_data_in_bpa_format() const
{
    return get_dynamic_data_in_psse_format();
}

string PVEX::get_dynamic_data_in_steps_format() const
{
    return get_dynamic_data_in_psse_format();
}
