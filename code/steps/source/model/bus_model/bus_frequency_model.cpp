...
BUS_FREQUENCY_MODEL::BUS_FREQUENCY_MODEL(iSTEPS& toolkit) : frequency_block(toolkit)
{
    set_toolkit(toolkit);
...
void BUS_FREQUENCY_MODEL::set_toolkit(iSTEPS& toolkit)
{
    this->toolkit = (&toolkit);
}

iSTEPS& BUS_FREQUENCY_MODEL::get_toolkit() const
{
    return *toolkit;
}
