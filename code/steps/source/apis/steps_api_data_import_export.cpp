...
void api_load_powerflow_data_from_file(char* file, char* file_type, size_t toolkit_index)
{
    ...
    if(string_file_type=="PSSE" or string_file_type=="PSS/E")
    {
        ...
        toolkit.importer.load_powerflow_data(file);
    }
    else
    {
...
void api_load_vsc_hvdc_powerflow_data_from_file(char* file, char* file_type, size_t toolkit_index)
{
    iSTEPS& toolkit = get_toolkit(toolkit_index);
    string string_file_type = string2upper(file_type);
    if(string_file_type=="iSTEPS" or string_file_type=="PSS/E")
    {
        //PSSE_IMEXPORTER importer(toolkit);
        toolkit.importer.load_vsc_powerflow_data(file);
    }
    else
    {
        if(string_file_type=="BPA")
...
void api_save_powerflow_data_to_file(char* file, char* file_type,
                                     ...
                                     bool export_internal_bus_number, size_t powerflow_data_save_mode,
                                     size_t toolkit_index)
{
    iSTEPS& toolkit = get_toolkit(toolkit_index);
    string string_file_type = string2upper(file_type);
    ...
    if(string_file_type=="PSSE" or string_file_type=="PSS/E")
    {
        ...
        toolkit.exporter.set_export_out_of_service_bus_logic(export_out_of_service_bus);
        toolkit.exporter.set_export_internal_bus_number_logic(export_internal_bus_number);
        toolkit.exporter.export_powerflow_data(file, export_zero_impedance_line, save_mode);
    }
    else
    {
        if(string_file_type=="BPA")
...
void api_save_vsc_hvdc_powerflow_data_to_file(char* file, char* file_type, size_t toolkit_index)
{
    iSTEPS& toolkit = get_toolkit(toolkit_index);
    string string_file_type = string2upper(file_type);
    if(string_file_type=="iSTEPS" or string_file_type=="PSS/E")
    {
        //PSSE_IMEXPORTER exporter(toolkit);
        toolkit.exporter.export_vsc_powerflow_data(file);
    }
}
...
void api_load_dynamic_data_from_file(char* file, char* file_type, size_t toolkit_index)
{
    ...
    {
        //PSSE_IMEXPORTER importer(toolkit);
        toolkit.importer.load_dynamic_data(file);
    }
    else
    {
        if(string_file_type=="BPA")
                                   ...
                                   size_t toolkit_index)
{
    ...
    if(string_file_type=="PSSE" or string_file_type=="PSS/E")
    {
        //PSSE_IMEXPORTER exporter(toolkit);
        toolkit.exporter.set_export_internal_bus_number_logic(export_internal_bus_number);
        toolkit.exporter.export_dynamic_data(file);
    }
    else
    {
        if(string_file_type=="BPA")
...
void api_load_sequence_data_from_file(char* file, char* file_type, size_t toolkit_index)
{
    iSTEPS& toolkit = get_toolkit(toolkit_index);
    string string_file_type = string2upper(file_type);
    if(string_file_type=="PSSE" or string_file_type=="PSS/E")
    {
        //PSSE_IMEXPORTER exporter(toolkit);
        toolkit.exporter.load_sequence_data(file);
    }
    else
    {
        ;
...
void api_save_sequence_data_to_file(char* file, char* file_type, size_t toolkit_index)
{
    iSTEPS& toolkit = get_toolkit(toolkit_index);
    string string_file_type = string2upper(file_type);
    if(string_file_type=="PSSE" or string_file_type=="PSS/E")
    {
        //PSSE_IMEXPORTER exporter(toolkit);
        toolkit.exporter.export_sequence_data(file);
    }
    else
    {
        ;
