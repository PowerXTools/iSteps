...
BPA_IMEXPORTER::BPA_IMEXPORTER(iSTEPS& toolkit) : DATA_IMEXPORTER(toolkit)
{
...
string BPA_IMEXPORTER::format_bpa_data_to_readable_data(string original_data, string format)
{
    ...
    if(type=="F")
    {
        ...
        else
        {
            ...
            sscanf(format.c_str(),"%c%zu.%zu",&tempc, &total_bits, &decimal_bits);
...
bool BPA_IMEXPORTER::load_powerflow_data(string file)
{
    ostringstream osstream;
...
void BPA_IMEXPORTER::load_pf_data_into_ram(string file)
{
    iSTEPS& toolkit = get_toolkit();
    dat_data_in_ram.clear();
...
void BPA_IMEXPORTER::convter_case_data()
{
    ;
}
...
void BPA_IMEXPORTER::convter_area_data()
{
    iSTEPS& toolkit = get_toolkit();
...
void BPA_IMEXPORTER::convter_zone_data()
{
    iSTEPS& toolkit = get_toolkit();
    PF_DATA& psdb = toolkit.get_database();
    size_t n = dat_data_in_ram.size();
...
void BPA_IMEXPORTER::convter_owner_data()
{
    iSTEPS& toolkit = get_toolkit();
    PF_DATA& psdb = toolkit.get_database();
    size_t n = dat_data_in_ram.size();
...
void BPA_IMEXPORTER::convter_bus_data()
{
    iSTEPS& toolkit = get_toolkit();
    PF_DATA& psdb = toolkit.get_database();
    size_t n = dat_data_in_ram.size();
...
void BPA_IMEXPORTER::convter_fixed_shunt_data()
{
    ;
}

void BPA_IMEXPORTER::convter_source_data()
{
    ;
}
...
void BPA_IMEXPORTER::convter_ac_line_data()
{
    iSTEPS& toolkit = get_toolkit();
    PF_DATA& psdb = toolkit.get_database();
    size_t n = dat_data_in_ram.size();
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(owner!=0)
                    {
                        ...
                        {
                            size_t iowner = ibus_ptr->get_owner_number();
                            size_t jowner = jbus_ptr->get_owner_number();
                            if(iowner==jowner)
                                line.set_meter_end_bus(ibus);
                            else
                            {
...
void BPA_IMEXPORTER::convter_transformer_data()
{
    iSTEPS& toolkit = get_toolkit();
    PF_DATA& psdb = toolkit.get_database();
    size_t n = dat_data_in_ram.size();
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(owner!=0)
                    {
                        ...
                        {
                            size_t primary_bus_owner = primary_bus_ptr->get_owner_number();
                            size_t secondary_bus_owner = secondary_bus_ptr->get_owner_number();
...
void BPA_IMEXPORTER::convter_2t_lcc_hvdc_data()
{
    iSTEPS& toolkit = get_toolkit();
    PF_DATA& psdb = toolkit.get_database();
    size_t n = dat_data_in_ram.size();
